...
def home():
    ...
    table_html = df.tail().to_html(classes='my-table')

    news = aapl.info
    news.pop('companyOfficers', 'longBusinessSummary')
    news.pop('longBusinessSummary', 'ticker')

    describe = df.describe()

            # Fetch stock data and calculate moving averages
    # Assume that you have already fetched the stock data and stored it in a DataFrame named `df`
    ...
    return render_template("home.html", news = news, user_input = user_input, table = table_html, describe = describe, chart_image1=chart_image1, chart_image2=chart_image2, chart_image3=chart_image3, chart_image4=chart_image4)        
...
def predict():
    ...
    # Plot the chart
        ...
        return render_template("home.html", news = news, describe = describe, user_input = user_input, table = table_html, chart_image1=chart_image1, chart_image2=chart_image2, chart_image3=chart_image3, chart_image4=chart_image4)
